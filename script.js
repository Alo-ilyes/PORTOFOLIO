...
fetchNews("cybersecurity", "Provide exactly 3 different French cybersecurity news articles not related to Israel and verify if url work well. Each article should be a single line with the title and URL only, separated by a hyphen (-). No additional comments.");
fetchNews("ai", "Provide exactly 3 different French AI news articles not related to Israel and verify if url work well. Each article should be a single line with the title and URL only, separated by a hyphen (-). No additional comments.");
fetchNews("network", "Provide exactly 3 different French IT and network news articles not related to Israel and verify if url work well. Each article should be a single line with the title and URL only, separated by a hyphen (-). No additional comments.");
